 ...
 * @author KuchiChai
 */
public class ZodMainFrame extends javax.swing.JFrame {

    /**
     * Creates new form ZodMainFrame
     */
    public ZodMainFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(400, 309));
        ...
        jLabel1.setBounds(130, 10, 118, 25);
        ...
        calculate.setBounds(180, 130, 90, 30);
        ...
        dayTF.setBounds(180, 90, 90, 20);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/zodiacgui/images/zodbgupdated.jpg"))); // NOI18N
        jLabel4.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jLabel4.setPreferredSize(new java.awt.Dimension(400, 350));
        getContentPane().add(jLabel4);
        jLabel4.setBounds(0, 0, 400, 309);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ZodMainFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ZodMainFrame().setVisible(true);
            }
        });
    }
